...
While no unique definition exists yet, it is possible to view data mining as the use of efficient techniques for the analysis of very large collection of data and the extraction of useful and possibly unexpected patterns in data in order to make decisions across various areas.
\begin{examplebox}[\textbf{Example: }Descriptive and predictive data mining]
    ...
    By contrast, predictive data mining focuses on using past observations to predict a target variable through supervised learning techniques. \newline
...
\begin{itemize}
    \item \textbf{Structured data: }Data is organized according to well-enforced schema that is enforced during storage.
    \item \textbf{Semi-structured data: }Data can be organized according to a structural schema, although the organization is not enforced during storage.
